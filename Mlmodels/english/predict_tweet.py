...
def predict(tweet_id):
    ...
    bert_cls = SentenceTransformer(r"F:\bert-base-nli-cls-token")
    ...
    path = r"F:\Covid19_FakeNews_Detection-master\GUI_MLModels\english\rfc_bert_cls_embeddings_text_user.pkl"
    rfc = joblib.load(path)
