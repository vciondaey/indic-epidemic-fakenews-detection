...
def get_feature_vector(tweet_id):
    ...
    sentence = Sentence(tweet_info[0])
    ...
    return final_encoding,tweet_info[0]
    




#path_train = r"C:\Users\Mohit Bhardwaj\Downloads\Covid Project\Dataset\Combined Multi-Lingual\mbert_combined_train_embeddings_text_user_dataset.csv"
#path_test  = r"C:\Users\Mohit Bhardwaj\Downloads\Covid Project\Dataset\Combined Multi-Lingual\mbert_combined_test_embeddings_text_user_dataset.csv"
#
...
#
#path = r"C:\Users\Mohit Bhardwaj\Downloads\Covid Project\GUI\CFTD Demo\model\rfc_mbert_embeddings_text_user.pkl"
#
...
def predict(tweet_id):
    ...
    final_encoding,tweet_info = get_feature_vector(tweet_id)
...
#    print(result)
    ...
    if(result[0][0]<=0.5):
        answer = "VERIFIED Tweet: " + tweet_info
    else:
        answer = "NOT VERIFIED Tweet: " + tweet_info

    return answer

#print(predict(tweet_id))

tweet_id=input("enter tweet_id:")
while True:
    if tweet_id=="0":
        break
    print(predict(tweet_id))
